...
def load_bridge_data():
    ...
    rephrase_files = [f for f in os.listdir('.') if f.startswith('bridge_instruction_rephrases_3') and f.endswith('.json')]
...
def main():
    ...
    output_file = f"json/bridge_openvla_actions_{timestamp}.json"
